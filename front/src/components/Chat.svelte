    ...
    <div id="chat" class="chat translateRightChat">
        <div>
            ...
            <ul class="listMessage">
                <li>
                    <span class="playerAName">Jacky </span>utilise <span class="cardName">Nimbus 2000</span>
                </li>
                <li>
                    <span class="playerAName">Jacky </span>utilise <span class="cardName">Imobilis </span>contre <span class="playerBName">Mathieu</span>
                </li>
                <li>
                    <span class="playerAName">Jacky </span>utilise <span class="cardName">Nimbus 2000</span>
                </li>
